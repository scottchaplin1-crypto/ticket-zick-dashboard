...
def base_template(content, title="Ticket Zick Dashboard", show_back=True, current_panel=None):
    ...
    <head>
        ...
        <style>
            ...
            .add-btn {{ background:linear-gradient(45deg,#00f0ff,#c026d3); color:black; width:52px; height:52px; border-radius:50%; font-size:28px; border:none; cursor:pointer; box-shadow:0 4px 15px rgba(0,240,255,0.3); }}
            ...
            .setting-card {{ background:#16213e; padding:35px 40px; border-radius:16px; margin:18px 0; border:1px solid #00f0ff22; }}
            input, select, textarea {{ background:#0f0f1a; color:#e0e0ff; border:2px solid #334155; border-radius:10px; padding:14px 18px; width:100%; font-size:16px; margin-top:8px; box-sizing:border-box; }}
            input:focus, select:focus, textarea:focus {{ border-color:#00f0ff; box-shadow:0 0 0 3px rgba(0,240,255,0.2); }}
            label {{ display:block; margin:16px 0 8px; font-weight:600; color:#a0a0ff; }}
            .toggle {{ accent-color:#00f0ff; transform:scale(1.5); }}
            .row {{ display:flex; align-items:center; gap:18px; margin:20px 0; }}
