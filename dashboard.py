...
def base_template(content, title="Ticket Zick Dashboard", show_back=True, current_panel=None):
    ...
    <head>
        ...
        <style>
            ...
            label {{ display:block; margin:16px 0 8px; font-weight:600; color:#a0a0ff; line-height:1.4; }}
...
def settings_general():
    ...
    <div class="setting-card">
        ...
        <p style="color:#888; margin-top:6px;">Users with support roles can claim tickets</p>
    </div>
